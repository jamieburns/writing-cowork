...
4. Verify the appropriate template exists:
   - `--shape=phase` → `${CLAUDE_PLUGIN_ROOT}/0_Product/templates/roadmap_phase.md`
   - `--shape=now-next-later` → `${CLAUDE_PLUGIN_ROOT}/0_Product/templates/roadmap_now_next_later.md`
...
- `${CLAUDE_PLUGIN_ROOT}/0_Product/templates/roadmap_<shape>.md not found in plugin install`
