...
Copy `${CLAUDE_PLUGIN_ROOT}/0_Product/templates/project_hub.md` from the plugin to `<vault>/project_hub.md`
...
3. Verify the plugin's `${CLAUDE_PLUGIN_ROOT}/0_Product/templates/project_hub.md` exists.

## Execution

1. Read `${CLAUDE_PLUGIN_ROOT}/0_Product/templates/project_hub.md` from the plugin.
...
- `${CLAUDE_PLUGIN_ROOT}/0_Product/templates/project_hub.md not found in plugin install`
