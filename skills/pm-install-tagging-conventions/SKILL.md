...
description: >
  ...
  reference doc. Copies 0_Product/templates/tagging_conventions.md into the vault's
...
Copy `${CLAUDE_PLUGIN_ROOT}/0_Product/templates/tagging_conventions.md` from the plugin to
...
4. Verify the plugin's `${CLAUDE_PLUGIN_ROOT}/0_Product/templates/tagging_conventions.md` exists.
...
- `${CLAUDE_PLUGIN_ROOT}/0_Product/templates/tagging_conventions.md not found in plugin install`
