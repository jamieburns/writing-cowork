...
| 7e4b1a93 | `drift_check.py` hardcodes consumer-layout paths: `config.vault / "process/active/todos.md"` (lines 544, 554) and `"process/active/roadmap.md"` (line 587). Not config keys — no vault on a different layout can point the todos/roadmap checks anywhere | v0.1.18 | pm | planned | 2026-07-30 | Found 2026-07-30 scoping `0d92f4a7`. Distinct from `a4e1c7b2` (columns) and `c6d05a91` (inert check) — same *class*: the checker returns "clean" instead of "input not found" |
